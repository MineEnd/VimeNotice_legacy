namespace VimeNotice
{
    partial class APIKey
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Вы можете добавить API Key, если вы собираетесь";
            // 
            // label2
            // 
            ...
            this.label2.Text = "добавлять много гильдий";
            // 
            // label3
            // 
            ...
            this.label3.Text = "Чтобы получить APIKey введите команду /api dev  ";
            // 
            // button1
            // 
            ...
            this.label5.Text = "Оставьте поле пустым и сохраните, чтобы удалить токен.";
            // 
            // APIKey
            // 
